...
public class PointND implements Iterable<String> {
    ...
    public GeneralValue getValue(String subFieldName) {
        ...
        if (values.containsKey(subFieldName)) {
            ...
            // the object to be returned is a GeneralValue created using the
    ...
    /**
     * return the size of the PointND object ie how many subfields a field has
     * 
     ...
     * 
     * @return String containing the PointND object in format of key = value;
     */
