...
/**
 * Contains constructor for Infant (created from Trial objects) Contains methods
 * for Infant objects
 * 
...
public class Infant extends MultipleItemAbstract {
     ...
     * infant ID Then goes into the directory and adds the files (weeks) for
     * that infant into an arrayList
     * 
     * @param directory
     *            where data files stored ("data" in this case)
     * @param infantID
     *            of baby we want data for
     * @throws IOException
     *             happens when input/output bad/doesn't exist
     */
    ...
    /**
     * Another Infant constructor creates an infant object using the infant and
     * the selected trials
     * 
     * @param infant
     *            that is used to create this subinfant
     * @param indices
     *            of the trials selected for infant
     */
