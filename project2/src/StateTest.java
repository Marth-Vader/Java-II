...
public class StateTest
{
    ...
    public void test()
    {
        ...
        Assert.assertEquals(1.000, test.getMinLeftWrist(0).getDoubleValue(), .00001); 
        
        //test getMaxLeftWrist
        Assert.assertEquals(2.000, test.getMaxLeftWrist(1).getDoubleValue(), .00001); 
        
        //test getAverageLeftWrist
        Assert.assertEquals(3.000, test.getAverageLeftWrist(2).getDoubleValue(), .00001); 
    }   
