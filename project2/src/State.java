...
public class State extends SingleItemAbstract
{
    ...
    /**
     * Implements the getMaxLeftWrist method in the SingleItemAbstract class
     * Gets the max value of left wrist given a dimension (0 for x, 1 for y, 2 for z)
     * @return max of type GeneralValue; returns whatever value is at the given dimension
     */
    public GeneralValue getMaxLeftWrist(int dim)
    {
        //return the max value of the left wrist for state object for given dimension
        return leftWrist.getDimValue(dim);
    }
    
    
    /**
     * Implements the getMinLeftWrist method in the SingleItemAbstract class
     * Gets the min value of left wrist given a dimension (0 for x, 1 for y, 2 for z)
     * @return min of type GeneralValue; returns whatever value is at the given dimension
     */
    public GeneralValue getMinLeftWrist(int dim)
    {   
        //return the min value of the left wrist for state object for given dimension
        return leftWrist.getDimValue(dim);
    }
    ...
    /**
     * Implements the getAverageLeftWrist method in the SingleItemAbstract class
     * Gets the average value of left wrist given a dimension (0 for x, 1 for y, 2 for z)
     * @return average of type GeneralValue; returns whatever value is at the given dimension
     */
    public GeneralValue getAverageLeftWrist(int dim)
    {
        //return the average value of the left wrist for state object for given dimension
        return leftWrist.getDimValue(dim);
    }
}
