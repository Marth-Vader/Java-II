...
public class ProgramTest {
    ...
    public void multipleAbstractTest() throws IOException {
        ...
        Assert.assertEquals("-0.125", infant2.getItem(2).getMaxState("right_wrist", 
                "y").getValue("right_wrist", "y").toString());
        ...
        Assert.assertEquals("invalid", infant2trial.getMaxState("left_wrist",
                "o").getValue("left_wrist",  "o").toString());
        
        //try to getMinState that doesn't exist
        Assert.assertEquals("invalid", infant2trial.getMinState("left_wrist",
                "u").getValue("left_wrist",  "u").toString());
        
        //try to getAverageValue that doesn't exist  
        Assert.assertEquals("invalid", infant2trial.getAverageValue("left_wrist",  
                "f").toString());  
